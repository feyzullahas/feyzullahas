export const translations = {
  tr: {
    nav: {
      ...
      contact: 'İletişim',
      languageToggle: 'EN',
      languageAriaLabel: 'Dili İngilizceye çevir',
    },
    hero: {
      imagePlaceholder: 'Resminizi buraya ekleyin',
    ...
    about: {
      ...
      highlights: {
        ...
        leadership: {
          title: 'Liderlik',
          lines: ['Pozisyon 1', 'Pozisyon 2'],
        },
      },
    },
    experience: {
      title: 'Deneyim & Liderlik',
      items: [
        {
    ...
    cv: {
      title: 'CV / Özgeçmiş',
      description: 'CV dosyamı PDF olarak indirebilir veya tarayıcıda görüntüleyebilirsiniz.',
      download: 'PDF İndir',
  ...
  en: {
    nav: {
      ...
      contact: 'Contact',
      languageToggle: 'TR',
      languageAriaLabel: 'Switch language to Turkish',
    },
    hero: {
    ...
    cv: {
      title: 'CV / Resume',
      description: 'You can download my CV as a PDF or view it in your browser.',
